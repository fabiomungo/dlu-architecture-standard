...
|---------|--------------|--------|-----|
| Engine + schema v1.0 | Neo4j 5 + APOC, labels/rels verified | ✅ | v2.0 migration 🔵 (STX-05 + A8/A9 aliases) |
...
| Query facade | `kg_query_service`, GraphRAG | ✅ | canonical library + budgets 🔵 |
| Learner plane | BKT ✅; overlay consumers 🔵 (STX-05) | 🔵 | WS03 rendering (STX-11) |
| Sync | `graph_sync_service_pi1`, `kg_event_bus`, fire-and-forget | ✅ | batched overlay consumers + lag metric 🔵 |
...
| A1 sunset | — | ⚪ | phases S1–S4 (S1 rides STX-05) |
