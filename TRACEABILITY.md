...
claim taxonomy) · NEW-04 ✅ (2026-07-19) → session-granular GPS (needs
NEW-05 aggregate + ESSE3 mirror for IT profile; NEW-04's `SIT_EXAM`/
`RETAKE` seam is ready for NEW-05 to fill).
