...
Recommendations v2 + WS03) → STX-10 (Subject Tutor + Learning Coach +
WS04/WS05): the SM-2 due-review candidate source and the
`recommendation_service_v2` slate are now real, so STX-10's Coach can
assemble review missions as first-class recommendations (BOOK-01 Ch. 3,
"compete equally, no privileged lane") against a live pipeline rather than
a stub; remaining nine-agents roster (Student Success, Career Advisor,
Credential) and STX-13 are not started and await explicit go-ahead.
