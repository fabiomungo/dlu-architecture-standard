...
**Persona × EKG-usage/RKG-maintenance (RFC-0002, BOOK-19 §1.2):** Researcher's EKG usage is the
federated zero-trust query path (T13, §3 below) over the anonymized graph; no RKG-maintenance
duty is assigned — Researcher is a consumer, not a graph steward.
